...
<head>
    <title>Trang quản lý vận chuyển</title>
                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="{{URL::TO('/delivery')}}" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Quản lý vận chuyển</span>
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Thao tác</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Quản lý giao hàng</h5>
                                            <p class="m-b-0">Chào mừng bạn đén với trang quản lý giao hàng</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
