                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="active">
                                    <a href="" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Quản lý sách</span>
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                ...
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.main">Thêm mới</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="{{URL::TO('/add-category')}}" class="waves-effect waves-dark">
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/add-type')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/add-status')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/add-supplier')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/add-author')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/add-product')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-direction-alt"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-22.main">Hiển thị</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="{{URL::TO('/all-category')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/all-type')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/all-status')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/all-supplier')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/all-author')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                ...
                                                <li class="">
                                                    <a href="{{URL::TO('/all-product')}}" class="waves-effect waves-dark">
                                                        <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Quản lý sách</h5>
                                            <p class="m-b-0">Chào mừng bạn tới trang quản lý sách</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
