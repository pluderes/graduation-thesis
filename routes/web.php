...
// export excel
Route::post('/export-invoice', 'adminManager@export_invoice');
// print invoice
Route::get('/print-invoice/{invoice_id}', 'adminManager@print_invoice');
...
// invoice delivered
Route::get('/admin-delivery-invoice-delivered/{acc_id}', 'adminManager@admin_delivery_invoice_delivered');
...
// invoice delivered
Route::get('/delivery-invoice-delivered/{acc_id}', 'deliveryManager@delivery_invoice_delivered');
...
// forgot
Route::get('/forgot', 'HomeController@forgot_password');
